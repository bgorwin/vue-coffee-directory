<template>
  <v-container>
      ...
      <v-col cols="12" justify="center">
        <div>
          <v-img class="overlay" src="../img/home-page-background.jpg" max-height="270">
            <h1 class="austin-heading text-center">Coffee Passport</h1>
          </v-img>
        </div>
      </v-col>
    </v-row>
    ...
    <v-row>
      <v-col cols="12" max-height="200px">
        <div>
          <h1 class="text-center">Choose A City</h1>
...
export default {
  ...
  data() {
    return {
      shops: shopData,
      cities: ["Austin", "Dallas", "San Francisco", "Los Angesles"]
    };
  }
};
</script>
